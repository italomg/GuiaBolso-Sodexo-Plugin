...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'GuiaBolso Sodexo Plugin'),
    );
  }
}
...
class MyHomePage extends StatefulWidget {
  ...
  factory MyHomePage({title}) {
    SharedPreferences.getInstance().
      then((localDatabaseFulfilled) => localDatabase = localDatabaseFulfilled);
    return MyHomePage.privateConstructor(title: title);
  }

  MyHomePage.privateConstructor({Key key, this.title}) : super(key: key);
